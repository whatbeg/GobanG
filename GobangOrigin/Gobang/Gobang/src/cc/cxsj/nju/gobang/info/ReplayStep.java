...
public class ReplayStep {
	...
	private static String[] transformer = new String[]{"◎", "◉"};
    static String path_black = System.getProperty("user.dir") + "/src/cc/cxsj/nju/gobang/Icons/black.png";
    static String path_white = System.getProperty("user.dir") + "/src/cc/cxsj/nju/gobang/Icons/white.png";
